...
- Volume on Alpaca with the 99 USD plan: yes, mechanically. No day-trade limit, real-time consolidated data at 10,000 requests a minute, and order throughput of 200 a minute, which covers hundreds of trades a day. Dozens a day is what the gap-up universe supplies (about 19 to 30 names). Hundreds a day means lower-quality names or higher frequency, where the tests above lose. Margin on each trade: no. In the best rule 44 percent of trades won; the mean was carried by a few large winners. The realistic target is a positive average per trade after costs, proven in shadow, then multiplied by volume. At 5,000 USD of capital that average is about 0.25 USD a trade; at 100,000 USD about 5 USD a trade, on about 19 trades a day, if the edge holds.
